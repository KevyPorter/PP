...
public class WStats {
    public static void display(String name) {
        ...
        try
        {
            coins = statistics.get("record").getAsJsonObject().get("stats").getAsJsonObject().get("Walls").getAsJsonObject().get("coins").getAsInt();
        }
        catch (Exception e) {}
        try
        {
            kills = statistics.get("record").getAsJsonObject().get("stats").getAsJsonObject().get("Walls").getAsJsonObject().get("kills").getAsInt();
        }
        catch (Exception e) {}
        try
        {
            wins = statistics.get("record").getAsJsonObject().get("stats").getAsJsonObject().get("Walls").getAsJsonObject().get("wins").getAsInt();
        }
        catch (Exception e) {}

        FormattedMessage.printSeparationMessage(EnumChatFormatting.YELLOW);
        new FormattedMessage(name + "'s stats in Walls", EnumChatFormatting.GREEN).send();
