...
public class UHCStats {
    public static void display(String name) {
        ...
        try
        {
            coins = statistics.get("record").getAsJsonObject().get("stats").getAsJsonObject().get("UHC").getAsJsonObject().get("coins").getAsInt();
        }
        catch (Exception e) {}
        try
        {
            kills = statistics.get("record").getAsJsonObject().get("stats").getAsJsonObject().get("UHC").getAsJsonObject().get("kills").getAsInt();
        }
        catch (Exception e) {}
        try
        {
            wins = statistics.get("record").getAsJsonObject().get("stats").getAsJsonObject().get("UHC").getAsJsonObject().get("wins").getAsInt();
        }
        catch (Exception e) {}

        FormattedMessage.printSeparationMessage(EnumChatFormatting.YELLOW);
        new FormattedMessage(name + "'s stats in UHC", EnumChatFormatting.GREEN).send();
